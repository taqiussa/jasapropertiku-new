<div class="card bg-dark text-white mb-3" style="height: 50vh">
    <img src="{{ asset('images/dwlimc.png') }}" class="card-img" alt="...">
                ...
                <div class="tab-content bg-dark h-auto px-5 py-5 bg-opacity-75" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-jual" role="tabpanel"
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input wire:model="jual" type="text" class="form-control" aria-label="Sizing example input"
                    ...
                    <div class="tab-pane fade" id="nav-sewa" role="tabpanel" aria-labelledby="nav-sewa-tab">
                        <div class="input-group input-group-lg">
                            ...
                            <input wire:model="sewa" type="text" class="form-control" aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-lg" placeholder="Cari....">
                        </div>
                    </div>
                </div>
