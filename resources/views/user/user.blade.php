    ...
    <div class="min-vh-100 my-5 d-flex justify-content-center row px-2">
        ...
        <div class="card col-lg-6 mx-1 my-1 py-1">
            <div class="card-header fs-3 border border-success border-bottom-0 border-top-0 border-5 d-flex justify-content-between bg-success bg-opacity-10">
                ...
                <a href="{{ route('user.edit', Auth::user()->name->slug) }}" class="btn btn-success" role="button">
            ...
            <div class="card-body">
                <div class="img my-2">
                    <img src="{{ asset('storage/'.Auth::user()->name->photo) }}" alt="" class="img-thumbnail rounded-circle">
                </div>
                <div class="form-floating mb-3">
                    <input disabled value="{{ Auth::user()->name->name }}" type="text" class="form-control" id="floatingNama" placeholder="Nama Lengkap..."
                        autocomplete="off">
                    <label for="floatingNama">Nama Lengkap</label>
                </div>
                <div class="form-floating mb-3">
                    <input disabled value="{{ Auth::user()->name->birthplace }}" type="text" class="form-control" id="floatingTempatLahir" placeholder="Tempat Lahir..."
                        autocomplete="off">
                    <label for="floatingTempatLahir">Tempat Lahir</label>
                </div>
                <div class="form-floating mb-3">
                    <input disabled value="{{ Auth::user()->name->birthdate }}" type="date" class="form-control" id="floatingTanggalLahir"
                        autocomplete="off">
                    <label for="floatingTanggalLahir">Tanggal Lahir</label>
                </div>
                <div class="form-floating mb-3">
                    <textarea disabled class="form-control" placeholder="Alamat Lengkap" id="floatingAlamat">{{ Auth::user()->name->address }}</textarea>
                ...
                <div class="form-floating mb-3">
                    <select disabled class="form-select" id="floatingProvinsi" aria-label="Floating label select example">
                        <option value="" selected>{{ Auth::user()->name->indonesiaProvince->name }}</option>
                    </select>
                ...
                <div class="form-floating mb-3">
                    <select disabled class="form-select" id="floatingKota" aria-label="Floating label select example">
                        <option value="" selected>{{ Auth::user()->name->indonesiaCity->name }}</option>
                    </select>
                ...
                <div class="form-floating mb-3">
                    <select disabled class="form-select" id="floatingKecamatan" aria-label="Floating label select example">
                        <option value="" selected>{{ Auth::user()->name->indonesiaDistrict->name }}</option>
                    </select>
                ...
                <div class="form-floating mb-3">
                    <select disabled class="form-select" id="floatingDesa" aria-label="Floating label select example">
                        <option value="" selected>{{ Auth::user()->name->indonesiaVillage->name }}</option>
                    </select>
                ...
                <div class="form-floating mb-3">
                    <select disabled class="form-select" id="floatingJenisKelamin" aria-label="Floating label select example">
                        <option selected>{{ Auth::user()->name->gender }}</option>
                    </select>
                    <label for="floatingJenisKelamin">Jenis Kelamin</label>
                </div>
                <div class="form-floating mb-3">
                    <input disabled value="{{ Auth::user()->name->whatsapp }}" type="text" class="form-control" id="floatingNoWhatsApp" placeholder="No. WhatsApp">
